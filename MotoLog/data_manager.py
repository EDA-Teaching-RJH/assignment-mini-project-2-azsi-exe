...
def add_bike(registration, brand, model, mileage): # This function allows user to save a bike into bikelog.csv
    with open("bikelog.csv", "a", newline="") as file: # Opens bikelog.csv file, a (append mode) allows it to be added, without deleting old data, and newline prevents blank lines from appearing.
